    ...
    <div class="row uk-text-small" style="font-size:10px;padding-left: 20px; padding-right: 20px; padding-top: 20px; border-bottom: 1px solid #54bc9c">
        <div class="col-md-3">
            <form class="uk-search uk-search-default" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                ...
                <input class="uk-search-input" type="search" name="search_term" id="search_term" placeholder="Search Switch Claims" value="<?php echo $search_value;?>">
...
<div class="col-md-7">
        ...
        <?php
        if($control->isGapCoverAdmin() || $control->isAdmin())
        {
        ?>
        <div class="col-md-2">
            <form action="classes/downloadSplit.php" method="POST">
                <input class="" type="hidden" name="swittc" id="swittc" value="">
            <button class="uk-button uk-button-default"><span uk-icon="cloud-download"></span> Download</button>
            </form>
        </div>
        <?php
        }
    ...
    <div id="myH">
        <div class="row uk-text-small" style="padding-left: 20px; padding-right: 15px;" >
            ...
            <th>Date Entered</th>    
                ...
                echo "</thead><tbody>";
                foreach($control->viewSeamlessClaims($start_from ,$limit,$search_value,0,$control->loggedAs(),2) as $row)
                {
...
<td>$id_number</td><td>$service_date</td><td>$end_date</td><td>$date_entered</td>
                ...
                echo "</tbody></table>";
                $total_records=$control->viewSeamlessClaims(1 ,10,$search_value,1,$control->loggedAs(),2);
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for (let key0 in hospital_lines)
                {
                    ...
                    let invc_num=hospital_lines[key0]["provider_invoicenumber"];
                    ...
                    $("#lines").append("<tr style='background-color: black; color: white'><td colspan='3'>"+proname+" - Inv No. : "+invc_num+"</td><td colspan='1'><span class='status pending'></span></td><td></td><td colspan='2'>"+forndata+"</td></tr>");
                    ...
                    {
                        let servicedate=claim_lines[key]["treatmentDate1"];
