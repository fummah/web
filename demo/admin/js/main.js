...
(function ($) {
  ...
  $container.append(
    '<h5>Customize MCA</h5><hr class="mb-2"/>'
  )
  ...
  $('.daterange').daterangepicker({
    ...
    naly();  
      ...
      $('#cleanUp').click(function () {
        ...
        $('#load').show();
        $.ajax({
          url: "../ajax/deleting.php?identity=11",
          type: "POST",
          data: obj,
      ...
      $('#srchBtn').click(function () {
        ...
        $.ajax({
          url: "../ajax/deleting.php?identity=12",
          type: "POST",
          data: obj,
          success: function (data) {
    ...
    function  deleteAll(claim) {
      ...
      $.ajax({
        url: "../ajax/deleting.php?identity=13",
        type: "POST",
        data: obj,
        success: function (data) {
    ...
    function  deletex(docID) {
      ...
      $.ajax({
        url: "../ajax/deleting.php?identity=14",
        type: "POST",
        data: obj,
        success: function (data) {
