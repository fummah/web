!(function(a){
	...
	a(function()
	{
			...
			var e=a("#bar").get(0).getContext("2d");
	            ...
	            new Chart(e,{
	            	...
	            	data:{
		                ...
		                datasets:[
		                	{
		                		label:"Revenue",backgroundColor:"#1ccab8",borderColor:"transparent",borderWidth:2,categoryPercentage:0.5,hoverBackgroundColor:"#00d8c2",
		...
		yAxes:[{
			...
			callback:function(e){if(!(e%10))return "$"+e+"k";},},},],},},});
			}
			}
	            );})(jQuery),
	            $("#world-map-markers").vectorMap({map:"world_mill_en",
			scaleColors:["#eff0f1","#eff0f1"],normalizeFunction:"polynomial",hoverOpacity:0.7,hoverColor:!1,regionStyle:{initial:{fill:"#7474b126"}},
			markers:[{latLng:[55.75,37.62],name:"Russia"},{latLng:[-25.27,133.77],name:"Australia"},{latLng:[20.59,78.96],name:"India"},
				{latLng:[39.52,-87.12],name:"Brazil"},],series:{regions:[{values:{US:"#868ff363",AU:"#868ff363",BR:"#868ff363",RU:"#868ff363"},
				attribute:"fill"}]},markerStyle:{initial:{stroke:"#7474b126"},hover:{stroke:"rgba(112, 112, 112, 0.30)"}},
				backgroundColor:"transparent",markers:[{latLng:[37.09024,-95.712891],name:"USA",style:{fill:"#f93b7a"}},
					{latLng:[55.754093,37.620407],name:"Russia",style:{fill:"#0aafff"}},{latLng:[-21.943369,123.102198],
					name:"Australia",style:{fill:"#7551e9"}},{latLng:[-11.409874,-41.280857],name:"Brazil",style:{fill:"#ffc212"}},],});
			...
			jQuery(function(e)
				...
				if(e("#platform_type_dates_donut").length)
				{
					...
					options:[{color:["#14256A","#64c5b1","#414b4f","#ee4b82","#45bbe0"],
						...
						orient:"vertical",padding:0,data:["iPhone 7","Windows","Desktop","Mobiles","Others"]},toolbox:{show:!0,
