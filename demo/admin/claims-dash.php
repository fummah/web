...
{
?>
    <a href="../coding/analysis.php" class="white_btn3" target="_blank" title="Closed Claims">
      <?php
}
else
{
      ?>
      <a href="#" class="white_btn3" target="_blank" title="Closed Claims">
        <?php
}
        ?>
...
<div class="dropdown-menu dropdown-menu-right">
    <a href="" onclick="window.open('pmbs.php?pmb=yes','popup','width=1000,height=600'); return false;"><button class="dropdown-item" type="button"><i class="ti-shift-right-alt"></i> PMB</button></a>
    <a href="" onclick="window.open('pmbs.php?pmb=no','popup','width=1000,height=600'); return false;"><button class="dropdown-item" type="button"><i class="ti-shift-left-alt"></i> NON-PMB</button></a>  
  </div>
</div>
</div>
</div>
...
<div class="box_header m-0">
<div class="main-title">
<h3 class="m-0">Claims Specialist Trend | <a href="compare.php" target="_blank"  class="mt-1 mb-1">Compare</a></h3>
...
<div class="dropdown">
<span class="dropdown-toggle" id="dropdownMenuButton" data-bs-toggle="dropdown">
<a onclick="window.open('section_analyse.php?section_name=schemes','popup','width=1000,height=600'); return false;"><button class="btn btn-small btn-danger">More...</button></a>
</span>
</div>
</div>
</div>
...
<div class="dropdown">
<span class="dropdown-toggle" id="dropdownMenuButton" data-bs-toggle="dropdown">
<a onclick="window.open('section_analyse.php?section_name=tariff_codes','popup','width=1000,height=600'); return false;"><button class="btn btn-small btn-danger">More...</button></a>
</span>
</div>
</div>
</div>
...
<div class="dropdown">
<span class="dropdown-toggle" id="dropdownMenuButton" data-bs-toggle="dropdown">
<a onclick="window.open('section_analyse.php?section_name=ICD10_codes','popup','width=1000,height=600'); return false;"><button class="btn btn-small btn-danger">More...</button></a>
</span>
</div>
</div>
</div>
