    ...
    <div class="uk-card uk-card-body" style="width: 100% !important; border:1px dotted black" >
        <div class="row" style="width: 100% !important;">
            <div class="col-md-2 uk-placeholder" style="padding-left:20px;padding-top: 20px; background-color: whitesmoke">
                ...
                <form id="mydownload" action="classes/downloadSplit.php" method="POST" style="display:none">
                    <input type="hidden" name="d1" id="d1">
                    <input type="hidden" name="d2" id="d2">
                    <input type="hidden" name="status" id="status">
                    <button class="button uk-button" name="spldownload"><span uk-icon="cloud-download"></span> Download</button>
                </form>
            </div>
            <div class="col-md-10">
                <div class="row">
