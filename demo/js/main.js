...
//console.log(data);
            ...
            for(var i=0;i<member_arr.length;i++)
            {
                ...
                var claim_id=member_arr[i]["claim_id"];
                var claim_number=member_arr[i]["claim_number"];
                $("#member_append").append("<form action='case_details.php' method='post'><input type='hidden' name='claim_id' value='"+claim_id+"'/><input type='submit' class='linkbutton' name='btn' value='"+claim_number+"'>");
            }
            for(var j=0;j<file_arr.length;j++)
            {
                ...
                var claim_id=file_arr[j]["claim_id"];
                var claim_number=file_arr[j]["claim_number"];
                $("#file_append").append("<form action='case_details.php' method='post'><input type='hidden' name='claim_id' value='"+claim_id+"'/><input type='submit' class='linkbutton' name='btn' value='"+claim_number+"'>");
            }
            for(var k=0;k<zero_arr.length;k++)
            {
                ...
                var claim_id=zero_arr[k]["claim_id"];
