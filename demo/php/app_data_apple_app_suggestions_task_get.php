...
try {
	...
	$tasks_ready = $client->get('/v3/app_data/apple/app_suggestions/tasks_ready');
			...
			if (isset($task['result'])) {
				foreach ($task['result'] as $task_ready) {
					...
					if (isset($task_ready['id'])) {
						$result[] = $client->get('/v3/app_data/apple/app_suggestions/task_get/advanced/' . $task_ready['id']);
					}
					*/
				}
			}
