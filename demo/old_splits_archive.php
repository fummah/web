...
<div class="row uk-text-small" style="font-size:10px;padding-left: 20px; padding-right: 20px; padding-top: 20px; border-bottom: 1px solid #54bc9c">
    <div class="col-md-6">
        <form class="uk-search uk-search-default" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
            ...
            <input class="uk-search-input" type="search" name="search_term" id="search_term" placeholder="Search Archived Claims" value="<?php echo $search_value;?>">
...
<div id="myH">
    <div class="row uk-text-small" style="padding-left: 20px; padding-right: 15px;" >
       ...
       <th>Loyalty Number</th>
            ...
            echo "</thead><tbody>";
            foreach($control->viewAllSplitClaimsDoctors($status,$start_from ,$limit,$search_value,0,1) as $row)
            {
...
<td>$hospital_name</td><td>$co_payment</td></tr>";
            ...
            echo "</tbody></table>";
            $total_records=$control->viewAllSplitClaimsDoctors($status,1 ,10,$search_value,1,1);
