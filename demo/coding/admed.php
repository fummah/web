...
<hr>
                ...
                <hr>
                    ...
                    <div class="uk-placeholder" style="color: #54bf99; font-weight: bolder; padding: 12px 12px 12px 12px !important;">
                        ...
                        <button class="uk-button uk-button-danger" onclick="orderByYear()">Group By Year</button>
                    </div>
    ...
    <div class="row">
        ...
        <div uk-spinner class="uk-animation-fade spinner" style="display: none; color: red"></div>
            <table border="1" id="myTable" class="myTable" style="width: 100% !important;">
                <thead>
