...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Elections'])
    ...
    <div class="container-fluid py-4">
        ...
        @include('components.alert')
                        ...
                        <div class="row top1" style="padding-bottom:10px !important">
                            <div class="col-md-4"><h6>Elections</h6></div>
                            <div class="col-md-4">
							@if(auth()->user()->role == "Admin")
							<button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#add_election">Add New Election</button>
						@endif
							</div>
							 <div class="col-md-4"> 
							 <form class="uk-search uk-search-default" action="{{ route('elections') }}" method="POST">
          @csrf
            <input class="uk-search-input" type="search" name="search_term" id="search_term" placeholder="Search election" value="{{$search_term}}">
    ...
    <header class="uk-comment-header">
        <div class="uk-grid-medium uk-flex-middle" uk-grid>          
			...
			<ul><li>
                <h5 class="uk-comment-title uk-margin-remove barlow" style="margin-bottom:10px !important;margin-left:10px !important;margin-right:10px !important"><a class="uk-link-reset" href="/details/election/writtenas/{{$election['id']}}">{{$election['election_name']}}</a></h5>
...
<input type="hidden" id="page" value="election">
        @include('layouts.footers.auth.footer')
    </div>
@include('modals.newelectionmodal')
