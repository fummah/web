...
<div class="et_pb_code_inner">
        <div class="et_pb_contact">
            <div class="et_pb_contact_form frmSearch" id="main1">
                <h1 align="center" class="et_pb_textb">Password Reset</h1>
                <p class="username" data-id="first_name" data-type="input">
                    <input type="text" class="input et_pb_textb" id="passcode" placeholder="Enter Code"/>

                </p>
                <p class="password" data-id="first_name" data-type="input">
                    <input type="password" class="input et_pb_textb" id="password" placeholder="Enter New Password"/>
                </p>
                <p class="password" data-id="first_name" data-type="input">
                    <input type="password" class="input et_pb_textb" id="newpassword" placeholder="Confirm Password"/>
                </p>

                <div class="pbtn">
                    <button type="submit" name="et_builder_submit_button" class="et_pb_contact_submit et_pb_button" onclick="changePassword()">Reset Password</button>

                    <div class="uk-alert-success" uk-alert>
                        <a class="uk-alert-close" uk-close></a>
                        <p>Successfully reset your password!!</p>
                    </div>
                    <p id="icct" class="uk-animation-scale-up talign"><a href="login.php">Back to Login Page</a></p>
