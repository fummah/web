...
<div class="row">
      ...
      <div class="col-md-3 item-field">Name <hr> <b>{{$project["first_name"]}} {{$project["last_name"]}}</b></div>
      ...
      <div class="col-md-3 item-field">
           <a type="button" href="{{url('customer_details')}}/{{$project['customer_id']}}" class="btn btn-warning btn-round" title="View Customer Details"><i class="now-ui-icons design_bullet-list-67"></i> View Customer Details</a>
      </div>
...
@else
<form action="{{ url('item/create/quote') }}/{{$project['customer_id']}}" method="GET" style="display: inline-block">
  @csrf 
  <input type="hidden" name="lead_id" value="{{$project['project_id']}}">
...
@else
<form action="{{ url('item/create/invoice') }}/{{$project['customer_id']}}" method="GET" style="display: inline-block">
  @csrf 
  <input type="hidden" name="lead_id" value="{{$project['project_id']}}">
