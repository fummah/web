...
<nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="https://webstartup.io">Home</a>
    </div>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navigation">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a href="https://webstartup.io/ai-white-label" class="nav-link">
            <i class="now-ui-icons design_app"></i> {{ __("White Label") }}
          </a>
        </li>
