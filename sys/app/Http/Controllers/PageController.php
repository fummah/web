...
class PageController extends Controller
{
     ...
     public function create_page(Request $request)
    {
        ...
        $project=ProjectsModel::join('subscribers','subscribers.id','=','projects.customer_id')->where('project_id','=',$project_id)->first();  
    ...
    public function create_project(Request $request)
    {
        ...
        $proObj->customer_id=$customer_id;
...
else
{
    ...
    return view('pages.projects',compact(['projects','role','customers']));
}
