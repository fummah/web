...
//
  ...
  var build_array=[];
  var current_clients=[];
  let trend_main_array4=[];
  let trend_main_total_array4=[];
$(function () {
...
//---------------------
  ...
  async function mystack(val,val1,clients,users,start_date,end_date)
  {
    var trend_main_array1=[];
    var trend_main_total_array1=[];
    let f1=getStack(val,val1,clients,users,start_date,end_date);
    f1.then(function(value){
      let f2=stackedf(value);
      f2.then(function(value){
        let objx=value;
        trend_main_array1=objx["trend_main_array4"];
        trend_main_total_array1=objx["trend_main_total_array4"];
  ...
  async function getStack(val,val1,clients,users,start_date,end_date)
  {
    $(".mychart1").empty();
...
return new Promise((resolve,reject)=>{
    ...
    build_array=[];
    current_clients=[];
    const objx={trend_main_array4:trend_main_array4,trend_main_total_array4:trend_main_total_array4}
    resolve(objx);
  });
  }
  function stackTrend(val,val1,clients,users,start_date,end_date)
  {
    var trend_main_array1=[];
    var trend_main_total_array1=[];
    let f1=stackTrendProcess(val,val1,clients,users,start_date,end_date);
    f1.then(function(value){
      let f2=stackedTrendSec(value);
      f2.then(function(value){
        let objx=value;
        trend_main_array1=objx["trend_main_array5"];
        trend_main_total_array1=objx["trend_main_total_array5"];
        trend_claim_array.reverse();
        trend_claim_total_array.reverse();
        trend_main_array.reverse();
        trend_main_array1.reverse();
  ...
  async function stackTrendProcess(val,val1,clients,users,start_date,end_date)
  {   
      return new Promise((resolve,reject)=>{
        $(".mychart2").empty();
  ...
  function stackedTrendSec(json2) {
    let trend_main_array5=[];
    let trend_main_total_array5=[];
return new Promise((resolve,reject)=>{
    $.each(json2, function(key, value){
      var full_date=json2[key].claim_date;
    ...
    build_array=[];
    current_clients=[];
    const objx={trend_main_array5:trend_main_array5,trend_main_total_array5:trend_main_total_array5};
    resolve(objx);
  })
  }
