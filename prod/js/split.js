...
let error_list=claim_lines[key]["errors"];
                    ...
                    $("#lines").append("<tr class='"+clas+"'><td uk-tooltip='title: "+error_list+"'>"+servicedate+"</td><td>"+icdcode+"</td><td title='"+file_name+"'>"+procedurecode+"</td><td>"+amountcharged+"</td><td>"+medicalschemerateinput+"</td><td>"+medicalschemepaidinput+"</td><td>"+portion+"</td><td>"+copayment+"</td></tr>");
