...
function claim_header($data,$control,$username)
{
    ...
    {
        $brokername=$control->viewSubscription($control->member_email);
    ...
    echo "<div class=\"row\" style=\"margin-bottom: 3px !important;box-shadow: 1px 1px 5px 2px white;border: 1px solid #e6e6e6; font-size: 14px !important; border-radius: 5px\">
            <div class=\"col-md-10\">
                ...
                <div class=\"row rowdetails\">
                    ...
                    <div class=\"col-md-4 $blinkx\">
                         Client Name : <b uk-tooltip=\"title: $brokertxt; pos: top-right\" style='color: #00b3ee'>".$control->client_name."</b>
                    </div>
                    <div class=\"col-md-4\">
            ...
            <div class=\"col-md-2\">
                <div>
                    <div class=\"uk-card uk-card-default uk-card-small uk-card-body\">                       
                        <h5 class=\"uk-card-title\">Owner Info</h5>
                        <p><span uk-icon=\"user\"></span> $owner_name</p>
                        <p><span uk-icon=\"mail\"></span><a href=\"$owner_email\" style=\"word-wrap: break-word;\"> $owner_email</a></p>
                        <p><span uk-icon=\"receiver\"></span> $owner_contact</p>
                    </div>
                </div>
            </div>
        </div>";
...
function doctor_line($doctor_arr,$claim_id,$control)
{
    ...
    if ($countdoctor > 0) {
        echo "<div class=\"row uk-animation-slide-bottom-medium\">
            <div class=\"col-md-12\">
              <p align='center' style='padding-top:5px; border-bottom:grey'><span class=\"uk-badge\" style='background-color: #54bf99 !important;'>$countdoctor</span> <b style='color: #54bf99'>Doctor(s) </b></p>
...
$decline_reason_id=$doctor_row["decline_reason_id"];
            ...
            echo "<tr class='text-info'><th></th><th colspan=\"8\"></th><th>[$doctor_chargedamnt]</th><th>[$doctor_schemeamnt]</th><th></th><th>[$doctor_gapamnt]</th></tr>";
...
function validations($claim_id,$control,$vaclinix,$arx05,$inhosparr,$vaclini,$emegncyarr,$codes3,$cdarry=array())
{
    ...
    $emegncyarr=array_intersect(["0011","0145","0146","0001","415","0147"],$emegncyarr);
