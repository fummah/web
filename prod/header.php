    ...
    <div class="maiin">
        <div class="nav-content">
            <ul class="" style="padding-bottom: 35px;padding-top: 15px">
                ...
                {
                    ?>
                    <li class="hidde <?php echo $script_leads;?>"><a href="leads.php">Leads <span class="spin" uk-spinner></span><span class="uk-badge sub_badge leads"> 0</span></a></li>
                    <li class="hidde <?php echo $script_qa;?>"><a href="view_quality.php">QA <span class="spin" uk-spinner></span><span class="uk-badge sub_badge" id="qa"> 0</span></a></li>

                    <?php
                    if($control->isAssessor() || $control->isTopLevel())
                    {
                        ?>
                        <li class="hidde <?php echo $script_preassment;?>"><a href="preassessed.php">Pre-Assessment <span class="spin" uk-spinner></span><span class="uk-badge sub_badge" id="pre_assessment"> 0</span></a></li>
                        <?php
                    }
                    if($control->isTopLevel())
                    {
                        ?>
                        <li class="<?php echo $script_clinical;?>"><a href="clinical_review.php">Clinical <span class="spin" uk-spinner></span><span class="uk-badge sub_badge" id="clinical"> 0</span></a></li>
                        <li class="<?php echo $script_im;?>"><a href="interface_manager.php">Interface Manager <span class="spin" uk-spinner></span><span class="uk-badge sub_badge" id="owls_error"> 0</span></a></li>

                        <?php
                    }
                }
                ?>
                <li class="<?php echo $script_openclaims;?>"><a href="open_claims.php">Open Claims <span class="spin" uk-spinner></span><span class="uk-badge sub_badge" id="open_claims"> 0</span></a></li>
                <li class="hidde">New Claims <span class="spin" uk-spinner></span><span class="uk-badge sub_badge" style="background-color: #84c4dc !important;" id="new_case"> 0</span></li>
                <?php
                ...
                if($control->isSplit())
                {
                    ...
                    ?>
                    <li class="<?php echo $script_splitclaims;?>"><a href="splits.php">Claims <span class="spin" uk-spinner></span></a></li>
                    <li class="<?php echo $script_oldsplits;?>"><a href="old_splits.php">Old Claims <span class="spin" uk-spinner></span></a></li>
                    <?php
                    if($control->isGapCoverAdmin())
                    {
                        ?>
                        <li class="<?php echo $script_dashsplits;?>"><a href="split_dashboard.php">Claims Dashboard <span class="spin" uk-spinner></span></a></li>
                        <?php
                    }
                }
                ...
                {
                    ?>
                    <li class="<?php echo $script_switch;?>"><a href="switch_claims.php">Switch Claims <span class="spin" uk-spinner></span></a></li>
                    <li class="<?php echo $script_oldswitch;?>"><a href="old_switch.php">Old Switch Claims<span class="spin" uk-spinner></span></a></li>
                    <?php
                    if($control->isBi())
                    {
                    ?>
                <li class="<?php echo $script_oldswitch;?>"><a href="coding/bi.php">BI Tool<span class="spin" uk-spinner></span></a></li>
