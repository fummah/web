...
return $this->db_action->getPendingSplitClaims($status,$fields,$row,$rowperpage,$columnIndex,$columnName,$columnSortOrder,$searchValue);
    ...
    public function viewAllSplitClaimsDoctors($status,$pageLimit ,$setLimit,$search_value="",$count=0)
    {
        try {
            $where = "WHERE ";
            if (strlen($search_value) > 0) {
                $where = "WHERE (a.loyalty_number like :search OR a.claim_number like :search OR b.membership_number like :search OR b.beneficiary_name) AND ";
                $search_value="%$search_value%";
            }
            $condition = "1";
...
//---->february in none leap years gave a remainder of 0 but still calculated weekends between first and last day, this is one way to fix it
    ...
    function holidays()
    {
        return array("01-02","03-21","04-07","04-10","04-27","05-01","06-16","08-09","09-25","12-16","12-25","12-26","12-27");
    }
