...
<head>
    ...
    <title>Med ClaimAssist: Consent Forms</title>
...
<div style="background-color: #d3d9df">
    ...
    <div class="container" style="width: 40%">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"
            ...
            <div class="row">
                <div class="col-sm-12">
                    <label> Medical Schemes : </label><select class="form-control" name="scheme" id="scheme"
...
if ($count > 0) {
    ...
    foreach ($stm->fetchAll() as $row) {
        ...
        echo "<form action='view_doc.php' method='post' target=\"print_popup\" onsubmit=\"window.open('edit_hospital.php','print_popup','width=1000,height=800');\"/><input type=\"hidden\" name=\"my_doc\" value=\"$desc\" />
