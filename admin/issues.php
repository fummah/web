...
$environment=validateXss($_POST['environment']);
 ...
 $new->sendMail($assignee,$initiator,$number,$subject,$descr,$tracker,$status,$initiator);
   ...
   $ttt=$new->selectRecords($myrole,$username,$status,$start_from,$myssst);
    ...
    <h3 style="margin-left: 10px"><u>Issues</u></h3>
    <hr>
   <form action="" method="post" >
<h4 style="margin-left: 10px">Status : <select onchange="this.form.submit()" name="sstatus" id="sstatus"><option value="Open">Open</option><option value="Closed">Closed</option></select></h4>
    </form>
    <br>
    <table width="100%" border="1" class="w3-table table-striped w3-animate-zoom w3-hover-shadow">
        <thead>
        <tr>
            <th>No#</th>
            <th>Tracker</th>
