...
class targetClass
{
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text"><?php echo $target_name;?> Target</span>
    ...
    function specialistsProgress($target,$monthly_target,$username,$charged="",$target_name="")
    {
        ...
        if($target_name=="Savings")
        {
            $perc=round(($monthlytarget/$charged)*100);
    ...
    function getCaret($target,$monthly_target,$variance,$percentage)
    {
        ...
        $data["caret"]="fas fa-arrow-up";
        if($target==$monthly_target)
        {
            $data["caret_txt"]="text-warning";
            $data["caret"]="fas fa-caret-left";
        }
        elseif ($variance<0)
        {
            $data["caret_txt"]="text-danger";
            $data["caret"]="fas fa-arrow-down";
        }
        if($percentage<50)
        {
