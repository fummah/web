...
charged_amnt as claimChargedAmnt,scheme_paid as schemePaidAmnt,gap as claimCalcAmnt,memberLiability,client_gap,savings_scheme,savings_discount FROM claim where claim_id=:num AND senderId=:kk');
