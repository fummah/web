    ...
    <script>
        function addNote() {
            ...
            if(notes!="") {
                ...
                $.ajax({
                    url:"ajaxPhp/deleting.php?identity=40",
                    type:"GET",
                    data:obj,
            ...
            for(i=0;i<files.length;i++)
            {
                ...
                xhr.onload = function () {
                    if (xhr.status == 200) {
                        ...
                        document.getElementById('myfiles').innerText = 'Please wait2 ...';
                    }
...
if(isset($_POST['promote']))
{
    ...
    <p align='center'>The Lead successfully promoted, you can go ahead and view the claim.</p>
        ...
        {
            //description,date_entered,entered_by
    ...
    <a class=\"uk-alert-close\" uk-close></a>
    <p align='center'>Failed to promote this lead, try again.</p>
</div>";
    }
}
...
<div class="container">
    ...
    <div class="row uk-card uk-card-default uk-card-body">
        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-4">Username : <b><?php echo $username;?></b></div>
                <div class="col-xs-4">Date Created : <b><?php echo $date_entered;?></b></div>
                    ...
                    <div class="uk-inline">
                        ...
                        <div uk-dropdown>
                            ...
                            foreach ($obj->getFiles($lead_id) as $rrow)
                            {
                                ...
                                echo "<form action='test5.php' method='post' target=\"print_popup\" onsubmit=\"window.open('test5.php','print_popup','width=1000,height=800');\"/><input type=\"hidden\" name=\"my_doc\" value=\"$desc\" />
...
<input type=\"submit\" class=\"linkbutton\" name=\"doc\" value=\"$nname\">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    elseif ($status==1)
                    {
                        echo "<form action='case_detail.php' method='post' /><input type=\"hidden\" name=\"claim_id\" value=\"$claim_id\" />
