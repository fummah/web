  ...
  $.ajax({
    ...
    success:function (data) {
      ...
      $.each(json2, function(key, value){
        var user=json2[key].username;
        var total=json2[key].total;
        open_user_array.push(user);
        open_user_total_array.push(total);
...
//Fetch open claims as per client
  $.ajax({
    url:"../ajaxPhp/reports.php",
    type:"GET",
    data:{identityNum:2},
    ...
    success:function (data) {
      ...
      $.each(json2, function(key, value){
        ...
        var total=json2[key].total;
        open_client_array.push(client);
        open_client_total_array.push(total);
  ...
  $.ajax({
    ...
    success:function (data) {
      ...
      $.each(json2, function(key, value){
        ...
        var total=json2[key].total;
        trend_claim_array.push(months[num]);
        trend_claim_total_array.push(total);
  ...
  $.ajax({
    ...
    success:function (data) {
      var json2= JSON.parse(data);
stackedf(json2,trend_main_array,trend_main_total_array);

      trend_main_array=trend_main_array4;
      trend_main_total_array=trend_main_total_array4;
      /*
          }*/
...
// Get context with jQuery - using jQuery's .get() method.
  ...
  var pieData    = {
    labels: open_client_array,
    datasets: [
      {
        data: open_client_total_array,
        backgroundColor :colors,
      }
    ]
  }
...
// Get context with jQuery - using jQuery's .get() method.
  ...
  var areaChartData = {
    labels  :trend_main_array,
    datasets: trend_main_total_array
  };
