<?php
session_start();
if(isset($_SESSION['logxged']) && !empty($_SESSION['logxged']) && $_SESSION['level'] == "admin" || $_SESSION['level'] == "claims_specialist") {
...
<head>
  ...
  <title>MCA | Incentive Model</title>
...
<script src="dist/js/qa2.js"></script>
<script>
