  ...
  <section class="content">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-tools">
                <button type="button" class="btn btn-success btn-sm" data-toggle="tooltip" title="Claims">
                  Claims
                </button>
    ...
    <div class="row vvc">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">QA Trend</h3>
...
<script src="dist/js/qa.js"></script>
<script>
