...
// meant to limit access and abilities below
...
$f2=function($create,$medclaimassist,$Patient){
    return true;
};
...
// uncomment the lines below when running in stand-alone mode:
 ...
 $api = new PHP_CRUD_API(array(
 	'dbengine'=>'MySQL',
 	'hostname'=>'sql19.cpt1.host-h.net',
 	'username'=>'greenwhc_6',
 	'password'=>'Tw0Ocean$2018!',
 	'database'=>'MCA_admin',
 	'charset'=>'utf8',
     'table_authorizer'=>$f2
 ));
 $api->executeCommand();
$mysql_hostname = 'sql19.cpt1.host-h.net';
    //$mysql_hostname = 'localhost';

    $mysql_username = 'greenwhc_6';
    //$mysql_username = 'tendai';

    $mysql_password = 'Tw0Ocean$2018!';
